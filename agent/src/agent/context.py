...
- When the user asks to save, export, or download a report, use the `save_report` tool with a short topic (e.g. 'AAPL_analysis'). The tool auto-prepends a timestamp. Do NOT save reports unless the user explicitly requests it.
