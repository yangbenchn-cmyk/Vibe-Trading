...
- When the user asks to save, export, or download a report, use the `save_report` tool. Name the file with the pattern: `YYYYMMDD_HHMM_topic.md` (e.g. `20260606_1430_AAPL_analysis.md`).
