...
Output:
    <project>/reports/alpha_bench_*.html      — per-run HTML reports
    <project>/reports/bench_<zoo>_<uni>.json  — per-run raw results
    <project>/reports/bench_summary.json      — aggregate summary
...
from src.config.paths import get_reports_dir  # noqa: E402
